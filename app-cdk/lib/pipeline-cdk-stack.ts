...
export class PipelineCdkStack extends Stack {
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const signerARNParameter = new ssm.StringParameter(this, 'SignerARNParam', {
      ...
      stringValue: 'arn:aws:signer:ap-northeast-1:302522969693:/signing-profiles/ecr_signing_profile',
    });
    ...
    pipeline.addStage({
      ...
      actions: [
        new codepipeline_actions.CodeStarConnectionsSourceAction({
          ...
          output: sourceOutput,
          branch: 'main',
          connectionArn: 'arn:aws:codeconnections:ap-northeast-1:302522969693:connection/68758548-8375-4ad3-b3ba-d995381f5a10',
        }),
      ],
    });
